    ...
    <main className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="mt-12 space-y-8 text-sm leading-relaxed text-[var(--text-secondary)]">
        <section>
          ...
          <p>
            InvoiceNudge is currently in pre-launch. By joining the waitlist, you are expressing interest in being notified when the
            service becomes available. No payment is required or processed at this stage.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Joining the waitlist does not guarantee access to the product, pricing, or features described on the landing page. Planned
            pricing and features are subject to change before launch.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            All content on this website, including text, design, and code, is the property of InvoiceNudge and its creators. You may
        ...
        <section>
          ...
          <p>
            This website is provided &quot;as is&quot; without warranties of any kind. We are not liable for any damages arising from
            your use of this website or reliance on information provided here.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-medium text-[var(--text-primary)] mb-3">Contact</h2>
          <p>Questions about these terms? Email us at hello@invoicenudge.com.</p>
        </section>
      </div>
    </main>
  );
