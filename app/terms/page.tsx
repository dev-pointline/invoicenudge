    ...
    <main className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="mt-12 space-y-8 text-[15px] leading-relaxed text-[var(--text-secondary)]">
        <section>
          ...
          <p>
            InvoiceNudge is currently in pre-launch. By joining the waitlist, you are 
            expressing interest in being notified when the service becomes available. 
            No payment is required or processed at this stage.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Joining the waitlist does not guarantee access to the product, specific 
            pricing, or features described on the landing page. Planned pricing and 
            features are subject to change before launch. We may prioritize access 
            based on signup date or other criteria.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            property of InvoiceNudge and its creators. You may not copy, reproduce, 
        ...
        <section>
          ...
          <p>
            ...
            use of this website or reliance on information provided here.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-medium text-[var(--text-primary)] mb-3">Future Terms</h2>
          <p>
            When InvoiceNudge launches, we will provide comprehensive terms of service 
            covering payment terms, refund policy (60-day money-back guarantee), 
            acceptable use, and data handling. You will be asked to accept these terms 
