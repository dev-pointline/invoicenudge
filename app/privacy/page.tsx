    ...
    <main className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="mt-12 space-y-8 text-sm leading-relaxed text-[var(--text-secondary)]">
        <section>
          ...
          <p>
            When you join our waitlist, we collect your email address. That&apos;s it. We don&apos;t use tracking cookies, analytics
            scripts, or third-party data collection tools on this page.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your email address is used solely to notify you when InvoiceNudge launches and to send occasional product updates. We will
            never sell, share, or rent your email address to third parties.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your email is stored securely on our servers. We use industry-standard security practices to protect your information.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            You can request deletion of your data at any time by contacting us at hello@invoicenudge.com. We will remove your
        ...
        <section>
          ...
          <p>Questions about this policy? Email us at hello@invoicenudge.com.</p>
        </section>
      </div>
    </main>
  );
